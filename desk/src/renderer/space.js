...
const messageOtherTemplate = document.getElementById(
  "space-message-other-template"
);
const messageSelfTemplate = document.getElementById(
  "space-message-self-template"
);
...
usernameButton.addEventListener("click", (e) => {
  ...
  if (nextUsername && nextUsername != "") {
    window.electron.ipcRenderer.sendMessage(ipcChannels.SET_USERNAME, {
